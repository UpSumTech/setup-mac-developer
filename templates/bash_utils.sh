...
pyenv_install_version() {
  ...
  PYENV_CFLAGS="-I$(brew --prefix gcc)/include"
  PYENV_CFLAGS="-I$(brew --prefix openssl)/include $PYENV_CFLAGS"
  ...
  PYENV_CFLAGS="-I$(brew --prefix mysql@8.0)/include $PYENV_CFLAGS"
  PYENV_CFLAGS="-I$(brew --prefix postgresql@16)/include $PYENV_CFLAGS"
  PYENV_CFLAGS="-I$(xcrun --show-sdk-path)/usr/include $PYENV_CFLAGS"

  PYENV_LDFLAGS="-L$(brew --prefix gcc)/lib"
  PYENV_LDFLAGS="-L$(brew --prefix openssl)/lib $PYENV_LDFLAGS"
  ...
  PYENV_LDFLAGS="-L$(brew --prefix mysql@8.0)/lib $PYENV_LDFLAGS"
  PYENV_LDFLAGS="-L$(brew --prefix postgresql@16)/lib $PYENV_LDFLAGS"
